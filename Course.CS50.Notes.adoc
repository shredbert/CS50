...
* *alls strings* in C end with special char to indicate ending -> `\0`
** *null character* or NUL
** 4 bytes needed for string with 3 chars
** fixed-size datatypes don't need
** other langs/libs might have variable length datatypes but can also be
   implemented by *recording* the # of bytes somehow?
